...
import { Check, Star, Crown, Image, Video, FileText, Layout } from 'lucide-react'
...
function AdTypesShowcase() {
  const adTypes = [
    ...
    },
    {
      ...
      preview: (
        <div className="border rounded-lg p-4 bg-white">
          <div className="w-full h-20 bg-gradient-to-r from-blue-500 to-red-500 rounded mb-3"></div>
...
export default function SuscripcionPage() {
  ...
  useEffect(() => {
    if (!authLoading && user && userProfile && userProfile.role !== 'anunciante') {
